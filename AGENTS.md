...
state/               runtime records and signals; gitignored
  ...
  <id>.chrome-devtools-session  task-scoped named bridge binding written by fm-spawn and stopped through chrome-devtools-axi before teardown safety checks; removed when cleanup completes

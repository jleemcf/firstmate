...
Only a confirmed provider release completes that retirement automatically; every failure or interruption preserves the claim and marker copies, leaves the record claimless, refuses every further destructive lifecycle action, and prints one deliberate manual-recovery drill rather than trying to infer whether restoration became safe.
